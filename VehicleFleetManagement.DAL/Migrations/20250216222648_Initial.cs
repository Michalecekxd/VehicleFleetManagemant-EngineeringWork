        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalInspectionValidUntil = table.Column<DateOnly>(type: "date", nullable: false),
                    InsuranceValidUntil = table.Column<DateTime>(type: "date", nullable: false),
                    CurbWeight = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    DeliveryVanType = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RigidTruckType = table.Column<int>(type: "integer", nullable: false),
                    Capacity = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RigidTrucks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurbWeight = table.Column<double>(type: "double precision", nullable: false),
                    IsDamaged = table.Column<bool>(type: "boolean", nullable: false),
                    SemiTrailerType = table.Column<int>(type: "integer", nullable: false),
                    Capacity = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TractorUnits_SemiTrailers_SemiTrailerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TractorUnits_SemiTrailerId",
                table: "TractorUnits",
